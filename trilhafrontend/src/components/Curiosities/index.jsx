import curiosities from "../../assets/curiosities.jpg";
function Curiosities() {
  return (
    <section id="curiosities" className="py-10 bg-black">
      <div className="w-[90%] xl:w-[70%] mx-auto flex flex-col gap-4">
        <h2 className="gradient-text text-3xl md:text-4xl font-bold text-center md:text-end">
          Curiosidades
        </h2>
        <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between gap-8 md:gap-0">
          ...
          />
          <div className="flex flex-col gap-4 md:gap-7 items-center text-center md:text-end text-base md:text-lg font-bold tracking-widest text-white md:w-1/2 lg:w-1/3 ">
