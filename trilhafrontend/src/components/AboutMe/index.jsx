...
function AboutMe() {
  return (
    <section id="about" className=" py-10 font-bold">
      <div className="w-[90%] xl:w-[70%] mx-auto flex flex-col items-center md:items-start gap-4">
        <h2 className="text-red text-3xl md:text-4xl font-condensed">Sobre mim</h2>
        <div className="flex flex-col md:flex-row-reverse items-center md:items-start gap-8">
          ...
          />
          <div className="flex flex-col gap-4 items-center text-center md:text-start text-base md:text-lg tracking-widest font-condensedItalic">
            <p>
